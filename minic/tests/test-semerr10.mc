//test bad, interface declared, class Person implements it and method calculateVacationDays returns different type
...
class Person implements Employee{
    ...
    unsigned calculateVacationDays(int experience){
        unsigned days;
        days = 5u;
        return days;
    }
